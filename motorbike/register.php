        ...
        <div class="screen__content">
            <form class="login" method="POST" action="">
                ...
                <div class="login__field">
                    ...
                    <input type="text" class="login__input" name="txtFullname" id="txtFullname" placeholder="Full Name" required>
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-envelope"></i>
                    <input type="text" class="login__input" name="txtEmail" id="txtEmail" placeholder="Your Email" required>
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-lock"></i>
                    <input type="password" class="login__input" name="txtPass1" id="txtPass1" placeholder="Password" required>
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-lock"></i>
                    <input type="password" class="login__input" name="txtPass2" id="txtPass2" placeholder="Confirm Password" required>
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-phone"></i>
                    <input type="text" class="login__input" name="txtPhone" id="txtPhone" placeholder="Your Phone" required>
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-home"></i>
                    <input type="text" class="login__input" name="txtAddress" id="txtAddress" placeholder="Your Address" required>
                </div>
